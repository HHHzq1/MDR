...
from transformers import BertModel, BertConfig, CLIPConfig, CLIPModel
from transformers.models.bert.modeling_bert import BertSelfAttention, BertSelfOutput, BertAttention, BertLayer, BertIntermediate, BertOutput
...
from models.XModules import SelfEncoder, CrossModalAlignment, GraphReasoning, SELayer, l2norm, SoftContrastiveLoss, AmbiguityLearning, Block as XBlock, DiffLoss
from models.InteractionModule import MultimodalInteractionModule
from models.Cells import BertPooler
...
class UnimoModel(nn.Module):
    def __init__(self, args, vision_config, text_config, add_pooling_layer=True, num_self_layer=1):
        ...
        self.block_fusion = XBlock([768, 768], 768)
